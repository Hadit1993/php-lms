                        ...
                        <form method="post" class="row" action="{{route('instructor.register')}}">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('name') is-invalid @enderror" type="text" name="name" id="name" placeholder="e.g. Alex">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('username') is-invalid @enderror" type="text" name="username" id="username" placeholder="e.g. Smith">
                                    <span class="la la-user input-icon"></span>
                                </div>
                                @error('username')
                                  <span class="text-danger">{{$message}}</span>
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('email') is-invalid @enderror" type="email" name="email" id="email" placeholder="e.g. alexsmith@gmail.com">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control @error('phone') is-invalid @enderror" type="tel" name="phone" id="phone" placeholder="0936********">
                            ...
                            <div class="input-box col-lg-12">
                                <label for="adddress" class="label-text">Address</label>
                                <div class="form-group">
                                    <input class="form-control form--control @error('address') is-invalid @enderror" type="text" name="address" id="address" placeholder="e.g. 12345 Little Baker St, Melbourne">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('password') is-invalid @enderror" type="password" name="password" id="password" placeholder="********">
