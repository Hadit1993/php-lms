                                            ...
                                            <ul class="row no-gutters">
                                                ...
                                                <li class="col-lg-3">
                                                    <div class="menu-banner position-relative h-100">
                                                        ...
                                                        <img src="{{asset('frontend/assets/images/menu-banner-img.jpg')}}" alt="menu banner image" class="w-100 h-100 rounded-rounded">
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <ul class="cart-dropdown-menu">
                                            <li class="media media-card">
                                                <a href="shopping-cart.html" class="media-img">
                                                    <img src="{{asset('frontend/assets/images/small-img.jpg')}}" alt="Cart image">
                                                </a>
