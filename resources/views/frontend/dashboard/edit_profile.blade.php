    ...
    <div class="setting-body">
        ...
        <div class="media media-card align-items-center" style="margin-bottom: 20px">
            <div class="media-img media-img-lg mr-4 bg-gray">
                <img class="mr-3" src="{{(!empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/no_profile.png')}}" alt="avatar image">
            </div>
            <div class="media-body">
            ...
            <div class="input-box col-lg-6">
                ...
                <div class="form-group">
                    <input class="form-control form--control" type="tel" name="phone" value="{{$profileData->phone}}">
