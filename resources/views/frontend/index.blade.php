            ...
            <div class="row">
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img1.jpg')}}" alt="Category image">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img2.jpg')}}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img3.jpg')}}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img4.jpg')}}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img5.jpg')}}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img6.jpg')}}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                    ...
                    <div class="row">
                            ...
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="course-details.html" class="d-block">
                                        <img class="card-img-top lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img8.jpg')}}" alt="Card image cap">
                                    </a>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="course-details.html" class="d-block">
                                        <img class="card-img-top lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img9.jpg')}}" alt="Card image cap">
                                    </a>
                                    <div class="course-badge-labels">
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="course-details.html" class="d-block">
                                        <img class="card-img-top lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img10.jpg')}}" alt="Card image cap">
                                    </a>
                                </div><!-- end card-image -->
                                <div class="card-body">
                                    <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="course-details.html" class="d-block">
                                        <img class="card-img-top lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img11.jpg')}}" alt="Card image cap">
                                    </a>
                                </div><!-- end card-image -->
                                <div class="card-body">
                                    <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="course-details.html" class="d-block">
                                        <img class="card-img-top lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img12.jpg')}}" alt="Card image cap">
                                    </a>
                                    <div class="course-badge-labels">
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="course-details.html" class="d-block">
                                        <img class="card-img-top lazy" src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img13.jpg')}}" alt="Card image cap">
                                    </a>
                                    <div class="course-badge-labels">
        ...
        <div class="container">
            ...
            <div class="course-carousel owl-action-styled owl--action-styled mt-30px">
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="{{asset('frontend/assets/images/img8.jpg')}}" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
                            <div class="course-badge">Bestseller</div>
                            <div class="course-badge blue">-39%</div>
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="{{asset('frontend/assets/images/img9.jpg')}}" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
                            <div class="course-badge">Bestseller</div>
                        </div>
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="{{asset('frontend/assets/images/img10.jpg')}}" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
                            <div class="course-badge green">Free</div>
                        </div>
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="{{asset('frontend/assets/images/img11.jpg')}}" alt="Card image cap">
                        </a>
                    </div><!-- end card-image -->
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="{{asset('frontend/assets/images/img12.jpg')}}" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            <img class="card-img-top" src="{{asset('frontend/assets/images/img13.jpg')}}" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
                            <div class="course-badge">Featured</div>
                        </div>
        ...
        <div class="testimonial-carousel owl-action-styled">
                ...
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{asset('frontend/assets/images/small-avatar-1.jpg')}}" alt="Testimonial avatar" class="rounded-full">
                        </div>
            ...
            <div class="card card-item">
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{asset('frontend/assets/images/small-avatar-2.jpg')}}" alt="Testimonial avatar" class="rounded-full">
                        </div>
                        <div class="media-body">
            ...
            <div class="card card-item">
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{asset('frontend/assets/images/small-avatar-3.jpg')}}" alt="Testimonial avatar" class="rounded-full">
                        </div>
                        <div class="media-body">
                            <h5>Jackob Hallac</h5>
                            <div class="d-flex align-items-center pt-1">
            ...
            <div class="card card-item">
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{asset('frontend/assets/images/small-avatar-4.jpg')}}" alt="Testimonial avatar" class="rounded-full">
                        </div>
                        <div class="media-body">
                            <h5>Lubic Duble</h5>
                            <div class="d-flex align-items-center pt-1">
            ...
            <div class="card card-item">
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{asset('frontend/assets/images/small-avatar-5.jpg')}}" alt="Testimonial avatar" class="rounded-full">
                        </div>
                        <div class="media-body">
                            <h5>Daniel Ward</h5>
                            <div class="d-flex align-items-center pt-1">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 ml-auto">
                <div class="generic-img-box">
                    <img src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img13.jpg')}}" alt="About image" class="img__item img__item-1 lazy">
                    <img src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/img14.jpg')}}" alt="About image" class="img__item img__item-2 lazy">
...
<section class="client-logo-area section-padding position-relative overflow-hidden text-center">
    ...
    <div class="container">
        ...
        <div class="client-logo-carousel pt-4">
            <a href="#" class="client-logo-item"><img src="{{asset('frontend/assets/images/sponsor-img.png')}}" alt="brand image"></a>
            <a href="#" class="client-logo-item"><img src="{{asset('frontend/assets/images/sponsor-img2.png')}}" alt="brand image"></a>
            <a href="#" class="client-logo-item"><img src="{{asset('frontend/assets/images/sponsor-img3.png')}}" alt="brand image"></a>
            <a href="#" class="client-logo-item"><img src="{{asset('frontend/assets/images/sponsor-img4.png')}}" alt="brand image"></a>
            <a href="#" class="client-logo-item"><img src="{{asset('frontend/assets/images/sponsor-img5.png')}}" alt="brand image"></a>
        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/small-img-2.jpg')}}" alt="card image" class="img-fluid rounded-full lazy">
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/small-img-3.jpg')}}" alt="card image" class="img-fluid rounded-full lazy">
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{asset('frontend/assets/images/img-loading.png')}}" data-src="{{asset('frontend/assets/images/small-img-4.jpg')}}" alt="card image" class="img-fluid rounded-full lazy">
